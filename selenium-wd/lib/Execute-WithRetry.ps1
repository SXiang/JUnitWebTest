<#
CREDITS: alexbevi (https://gist.github.com/alexbevi/34b700ff7c7c53c7780b)
...
Params:
    ...
    VerboseOutput   - More info about internal processing
                      (default: false)
Examples:
Execute-WithRetry { $connection.Open() }
$result = Execute-WithRetry -RetryDelay 1 -MaxRetries 2 { $command.ExecuteReader() }
#>
