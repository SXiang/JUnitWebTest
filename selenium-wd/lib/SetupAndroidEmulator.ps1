...
#           -AndroidSDKPackageIDs "2,12,14,38,136" `
#           -HaxmPackageID "186"  `
...
(
   ...
   [Parameter(Mandatory=$true)]
   [string] $AndroidSDKPackageIDs,                          # Eg. "2,12,14,38,131", # comma-seperated list of ids from => android list sdk --all
                                                            ...
                                                            #    136 - Google APIs, Android API 23, revision 1
   [Parameter(Mandatory=$true)]
   [string] $HaxmPackageID,                                 # Eg. "186", # id from => android list sdk --all
