...
set "cmdArgs=%cmdArgs% -ResponseContentLength %~1 -NumConcurrentRequests %~2 -NumRequestsInOneSession %~3 -VerifyContentLength:%~4 -PostResultToAutomationDB:%~5 -NumPrimingRuns %~6 -RunUUID %~7 -TestCaseName '%~8' -OutputFolder '%~9'; exit;"
