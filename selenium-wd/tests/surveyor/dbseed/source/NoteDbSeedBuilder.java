...
public class NoteDbSeedBuilder extends BaseDbSeedBuilder {
	private static final String TABLE_NAME = "[dbo].[Note]";
	private static final String SEED_DATA_FOLDER = SURVEY_SEED_DATA_FOLDER;
	private static final String SEED_FILE_NAME = "NoteSeed.csv";

	public NoteDbSeedBuilder() {
		setSeedFilePath(SEED_DATA_FOLDER, SEED_FILE_NAME);
	}

	public NoteDbSeedBuilder(String seedFileName) {
	...
	public DbSeed build() throws FileNotFoundException, IOException {
        ...
        try
        {
            ...
            fileRecord.addColumnMetadata(6, null, java.sql.Types.DOUBLE, 0, 0);  
            fileRecord.addColumnMetadata(7, null, java.sql.Types.NVARCHAR, 50, 0);  
            fileRecord.addColumnMetadata(8, null, java.sql.Types.BIT, 0, 0);  
