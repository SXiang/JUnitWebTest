...
public class ObserverViewPageTest extends BaseMapViewTest {
	 ...
	 * Script: -  	
	 * Pre-requisite:
	 * - At least one of the surveyors should be active/online
	 * - On Home Page, click on Picarro Surveyors -& Online
	 * Results: - 
	 * - Mode button not present. Start Driving Survey, Stop Driving Survey and shutdown analyzer buttons are not present
	 */
	@Test
	...
	/**
	 * Test Case ID: TC346_ViewOperatorSurveyObserverViewWhenEverythingLoaded
	 * Script: -  	
	 *	- - On Home Page, click on Picarro Surveyors -& Online
	 *	- Display: All ON
	 *	- Position auto-center: ON
	 *	- Map View: Map
	 *	- GIS: All ON
	 * Results: - 
	...
	/**
	 * Test Case ID: TC347_ViewOperatorSurveySatelliteViewWhenGISDataLoaded
	 * Script: -  	
	 *	- - On Home Page, click on Picarro Surveyors -& Online Display: All on, Position auto-center: On,  Map View: Satellite,  GIS: All on
	 * Results: - 
	...
	/**
	 * Test Case ID: TC348_ViewOperatorSurveyWhenAllDisplayGISOptionsAreTurnedOFF
	 * Script: -  	
	 *	- - On Home Page, click on Picarro Surveyors -& Online
	 *	- Display: All OFF, Position auto-center: OFF,  Map View: Map,  GIS: All OFF Status: No alarms
	 * Results: - 
	 *	- Survey Information is displayed in map view to observer Tag, Mode, Time, Survey Active, Driver Info, Elapsed time, Remaining Time, Zoom level, Surveyor and analyzer info
	 *	- Car position, breadcrumb is displayed to the user
	...
	/**
	 * Test Case ID: TC349_ViewStandardSurveyWhenAllBoundariesPipeTypesAreLoaded
	 * Script: -  	
	 *	- - On Home Page, click on Picarro Surveyors -& Online
	 *	- Display: All on, Position auto-center: On,  Map View: Map,  GIS: All pipe types and boundaries on
	 * Results: - 
	 *	- User can see car position, wind rose, concentration chart, breadcrumb, FOV, Indications, LISA, Isotopic Analysis results (if any) and Field Notes (if any)
	 *	- All pipes data and boundaries are displayed
	 */
	...
	/**
	 * Test Case ID: TC350_ViewStandardSurveySatelliteViewWhenAllMapBoundariesPipeTypeAreLoaded
	 * Script: -  	
	 *	- - On Home Page, click on Picarro Surveyors -& Online
	 *	- Display: All on, Position auto-center: On,  Map View: Satellite,  GIS: All ON
	 *	- User can see car position, wind rose, concentration chart, breadcrumb, FOV, Indications, LISA, Isotopic Analysis results (if any) and Field Notes (if any) in satellite view
	 * Results: - 
	 *	- All pipes data and boundaries are displayed
	 */
	...
	/**
	 * Test Case ID: TC351_ViewStandardSurveyWhenAllDisplayOptionsGISAreTurnedOFF
	 * Script: -  	
	 *	- - On Home Page, click on Picarro Surveyors -& Online
	 *	- Display: All OFF, Position auto-center: OFF,  Map View: Map,  GIS: All OFF Status: No alarms
	 *	- Survey Information is displayed in map view to observer Tag, Mode, Time, Survey Active, Driver Info, Elapsed time, Remaining Time, Zoom level, Surveyor and analyzer info
	...
	/**
	 * Test Case ID: TC352_ChangesDoneByObserverObserveViewAreNotReflectedDriverView
	 * Script: -  	
	 *	- - On Home Page, click on Picarro Surveyors -& Online 
	 *	- - Turn OFF few display, Turn ON all assets and boundaries
	 * Results: - 
	 *  - Driver View should not be affected.
	 */
	@Test
	...
	/**
	 * Test Case ID: TC356_ViewOperatorSurveyFOVIndicationsLisasWhenBoundariesLoaded
	 * Script: -  	
	 *	- - On Home Page, click on Picarro Surveyors -& Online
	 *	- Display: Wind rose ON
	 *	- Concentration chart ON
	 *	- Isotopic Analysis OFF
	 *	- Field Notes OFF
	 *	- Indications ON
	 *	- LISAs ON
	 *	- FOV ON,
	 *	- Position auto-center: On,
	 *	- Map View: Map
	 *	- GIS: Boundaries All ON
	 * Results: - 
	 *  - Survey in-progress and Survey Information is displayed in map view - Tag, Mode, Time, Survey Active, Driver Info, Elapsed time, Remaining Time, Zoom level, Surveyor and analyzer info
	 *	- Car position, wind rose, concentration chart, breadcrumb, Indications, Lisa, FoV is displayed on map along with boundaries data
	...
	/**
	 * Test Case ID: TC357_ViewFOVIndicationsLisasDataStandardSurveyWhenBoundariesLoaded
	 * Script: -  	
	 *	- - On Home Page, click on Picarro Surveyors -& Online
	 *	- Display: Wind rose ON
	 *	- Concentration chart ON
	...
	/**
	 * Test Case ID: TC1037_ObserverView_OnceUserStartsNewSurveyOldSurveyShouldNotDisplayedObserverView
	 * Script: -  	
	 *	- - On Home Page, click on Picarro Surveyors -& Online
	 *  - Ask driver user to stop the survey
	 *	- - Now ask driver user to start the survey again with different survey tag value (eg. tag - Survey 2)
	 * Results: - 
	...
	/**
	 * Test Case ID: TC1262_ObserverView_ReturningFromCurtainViewShouldRestoreUserSelectedMapViewCombination
	 * Script: -  	
	 *  - Log in to application and navigate to observer view
	 *	- - Select Map view
	...
	/**
	 * Test Case ID: TC1273_ObserverViewTimeShouldChangePerTimezoneSelected
	 * Script: -  
	 * - Log in to SQA	
	 * - - Navigate to observer view
	 * - Suppose user system time is in PDT. Change it to CDT 
	 * Results: - 
	...
	/**
	 * Test Case ID: TC1375_ObserverView_CurtainView_ChangeInvocationOfOLCesium
	 * Script: -  	
	 *  - 1) Log into Observer View
	 *	- 2) While the survey is running, click the Curtain button
	 *	- 3) Click on the Return button and refresh the page
	 *	- 4) Let the survey continue for a few more minutes
	 *	- 5) Click on the Curtain button
	 * Results: - 
	 *	1) When the Curtain button is clicked, "Connecting" screen will appear, 
	 *     followed by car icon. Background map/satellite will gradually appear, 
	 *     along with blue wall (curtain) along the vehicle's route from the beginning of the survey
	...
	/**
	 * Test Case ID: TC1411_ObserverView_AssessmentSurvey_CurtainViewDisplayedUserAbleFollowVehicle
	 * Script: -  	
	...
	/**
	 * Test Case ID: TC1412_ObserverView_AssessmentModeSurvey_UserAllowedMoveUpDownLeftRightZoomInZoomOutCurtainView
	 * Script: -  	
	 *	- - On Home Page, click on Picarro Surveyors -& Online -& Curtain 
	 *	- - Click Up 
	 *	- - Click Right 
	...
	/**
	 * Test Case ID: TC1413_ObserverView_AssessmentModeSurvey_ReturningFromCurtainViewShouldRestoreUserSelectedMapViewCombination
	 * Script: -  	
	 *  - Log in to application and navigate to observer view
	 *	- - Select Map view
	 *	- - Click on Curtain View
	...
	/**
	 * Test Case ID: TC1453_ObserverView_CheckAssessmentSurveyDataPresentAfterObserverRefreshesBrowser_Satellite
	 * Script: -  	
	 *	- - On Home Page, click on Picarro Surveyors -& Online
	 *	- - Click on Map and turn Satellite View ON
	 *	- - On the Display menu, turn Concentration Chart and LISAs OFF. Leave other options ON
	 *	- - On the GIS menu, turn all Material Types ON, leave Boundaries OFF
	 *	- - Refresh the browser after couple of mins
	 * Results: - 
	 *  - After refreshing, survey data should be present 
	...
	/**
	 * Test Case ID: TC1454_ObserverView_CheckAssessmentSurveyDataPresentAfterObserverRefreshesBrowser_Map
	 * Script: -  	
	 *	- - On Home Page, click on Picarro Surveyors -& Online
	 *	- - Click on Map and turn Map View ON
	 *	- - On the Display menu, leave Concentration Chart Turn other options OFF
	 *	- - On the GIS menu, leave all Material Types OFF, turn Boundaries ON
	 *	- - Refresh the browser after couple of mins
	 * Results: - 
	 * - After refreshing, survey data should be present 
	 * - Survey details - Tag, Mode, Current Time, Survey Active, Driver Name, Stability Class, Elapsed Time, Remaining Time, Surveyor Name and Zoom Level should be present 
	...
	/**
	 * Test Case ID: TC1457_ViewAssessmentSurveyObserverViewWhenEverythingLoaded
	 * Script: -  	
	 *	- - On Home Page, click on Picarro Surveyors -& Online
	 *	- Display: All ON
	 *	- Position auto-center: ON
	...
	/**
	 * Test Case ID: TC1458_ViewAssessmentSurveySatelliteViewWhenGISDataLoaded
	 * Script: -  	
	 *	- - On Home Page, click on Picarro Surveyors -& Online 
	 *  - Display: All on, Position auto-center: On,  
	 *  - Map View: Satellite,  
	 *  - GIS: All on
	 * Results: - 
	...
	/**
	 * Test Case ID: TC1459_ViewAssessmentModeSurveyWhenAllDisplayGISOptionsAreTurnedOFF
	 * Script: -  	
	 *	- - On Home Page, click on Picarro Surveyors -& Online
	 *	- Display: All OFF,
	 *	- Position auto-center: OFF,
	 *	- Map View: Map,
	 *	- GIS: All OFF
	 *	- Status: No alarms
	 * Results: - 
	...
	/**
	 * Test Case ID: TC1460_ViewAssessmentModeSurveyObserverMapViewWhenFovIndicationWindRoseConcentrationChartON
	 * Script: -  	
	 *	- - On Home Page, click on Picarro Surveyors -& Online
	 *	- - Click Display
	 *	- Windrose - ON
	 *	- Concentration Chart - OFF
	 *	- FoV - ON
	 *	- - Click GIS
	 *	- All options ON
	 *	- - Click on Map and turn Map view ON
	...
	/**
	 * Test Case ID: TC1461_ViewAssessmentModeSurveyObserverMapViewWhenAllDisplayOptionsAreONOtherPlasticProtectedSteelCastIronAssetsONBoundariesOFF
	 * Script: -  	
	 *	- - On Home Page, click on Picarro Surveyors -& Online
	 *	- - Click Display
	 *	- All options (FOV,Windrose,Concentration chart) - ON
	 *	- - Click GIS
	 *	- Assets: Other Plastic, Protected steel, Cast iron - ON
	 *	- Boundaries: OFF
	 *	- - Click on Map and turn Map view ON
	 * Results: - 
	 *	- Breadcrumb, car position, Concentration Chart, Wind rose, FOV and survey information is displayed on map
	...
	/**
	 * Test Case ID: TC1462_ViewAssessmentModeSurveyObserverMapViewWhenFOVONAssetsBoundariesOFFSatelliteView
	 * Script: -  	
	 *	- - On Home Page, click on Picarro Surveyors -& Online
	 *	- - Click Display
	 *	- FOV- ON
	 *	- All other options(Windrose, concentration Chart) - OFF
	 *	- - Click GIS
	 *	- All options OFF
	 *	- - Click on Map and turn Satelite view ON
	 *	- Car position, Breadcrumb and FOV are displayed on map
	 * Results: - 
