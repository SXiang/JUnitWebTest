...
public class MeasurementSessionsPageTest extends SurveyorBaseTest {
     ...
     * Improvement: - Visibility check, a customer user should be able to see all surveys generated by the other customer users with different roles 
	 */
	@Test
	public void HOME015() {
	 ...
	 * Improvement: 1. Delete S1 survey for now and should be the same for deleting surveys with different types
