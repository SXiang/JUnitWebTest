...
public class MobileEULAPage extends SurveyorBasePage {
	 ...
	 * @param testSetup
	 */
	public MobileEULAPage(WebDriver driver, String baseURL, TestSetup testSetup) {
     ...
     */
    public MobileEULAPage clickIAcceptButton() {
     ...
     * @return the EULAPage class instance.
     */
    public MobileEULAPage verifyPageUrl() {
        (new WebDriverWait(driver, timeout)).until(new ExpectedCondition<Boolean>() {
            public Boolean apply(WebDriver d) {
