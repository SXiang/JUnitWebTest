...
public class BaseReportEntity {
	...
	private static void populateGuidMaps() {
		...
		SurveyModeFilterGuids.put("xxxxxxxxxxxxxxxxxxxxxxxTBD", SurveyModeFilter.Analytics);
		...
		ReportSurveyModeFilterGuids.put("xxxxxxxxxxxxxxxxxxxxTBD", ReportModeFilter.Analytics);
