...
public class DriverViewPageActions extends BaseDrivingViewPageActions {
	...
	public boolean invokeAction(String actionName, String data, Integer dataRowID) throws Exception {
		...
		else if (actionName.equals("verifySurveyModeDialogIsShown")) { return this.verifySurveyModeDialogIsShown(data, dataRowID); }
		else if (actionName.equals("verifySurveyModeDialogIsNotShown")) { return this.verifySurveyModeDialogIsNotShown(data, dataRowID); }
		else if (actionName.equals("verifyCorrectSurveyActiveMessageIsShownOnMap")) { return this.verifyCorrectSurveyActiveMessageIsShownOnMap(data, dataRowID); }
