...
public class GridPOCTestClass5 extends GridPOCBaseTest {
	...
	@Test
	public void TC251_LoginTest_PicarroAdmin() {
		getLoginPage().open();
	...
	@Test
	public void TC251_LoginTest_CustomerAdmin() {
		getLoginPage().open();
	...
	@Test
	public void TC251_LoginTest_CustomerDriver() {
		getLoginPage().open();
