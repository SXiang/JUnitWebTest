...
public class GridPOCTestClass3 extends GridPOCBaseTest {
	...
	@Test
	public void TC250_LoginTest_PicarroAdmin() {
		getLoginPage().open();
	...
	@Test
	public void TC250_LoginTest_CustomerAdmin() {
		getLoginPage().open();
	...
	@Test
	public void TC250_LoginTest_CustomerDriver() {
		getLoginPage().open();
