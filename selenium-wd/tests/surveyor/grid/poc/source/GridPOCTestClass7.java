...
public class GridPOCTestClass7 extends GridPOCBaseTest {
	...
	@Test
	public void TC252_LoginTest_PicarroAdmin() {
		getLoginPage().open();
	...
	@Test
	public void TC252_LoginTest_CustomerAdmin() {
		getLoginPage().open();
	...
	@Test
	public void TC252_LoginTest_CustomerDriver() {
		getLoginPage().open();
