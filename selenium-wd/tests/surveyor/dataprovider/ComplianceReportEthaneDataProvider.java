...
public class ComplianceReportEthaneDataProvider extends ReportDataProvider {
	...
	public static Object[][] dataProviderEthaneComplianceReport() throws Exception {
		...
		return new Object[][] {				
				/*{ "1"index, SQAPICSUPstrCreatedBy, USERPASSWORDHASHpassword(encrypted), "Picarro"customer, TIMEZONEPTtimeZone, ETHREXCLUSIONRADIUSexclusionRadius, nullsurveyorUnit, nulluserName, nullstartDate,
					nullendDate, nullfovOpacity, nulllisaOpacity, nullgeoFilter, ReportModeFilter.StandardreportMode, nullsurveyModeFilter, EthaneFilter.ExcludeVehicleExhaustethaneFilter, createMapAndBoundaryList(false includeCustomBoundary)listBoundary, tagList1tagList, tablesListtablesList, viewListviewList, viewLayerListviewLayersList },
