...
public class ImageSimilarityUtility {
		...
		private ImageSimilarityUtility(String file1, String file2) {
			this(ImagingUtility.loadImage(file1), ImagingUtility.loadImage(file2));
		}

		// constructor 2. use awt images.
		private ImageSimilarityUtility(Image _img1, Image _img2) {
			img1 = ImagingUtility.imageToBufferedImage(_img1);
			img2 = ImagingUtility.imageToBufferedImage(_img2);
		}
		...
		private void compare() {
			...
			imgc = ImagingUtility.imageToBufferedImage(img1);
			Graphics2D gc = imgc.createGraphics();
			gc.setColor(Color.RED);

			// convert to gray images.
			img1 = ImagingUtility.imageToBufferedImage(GrayFilter.createDisabledImage(img1));
			img2 = ImagingUtility.imageToBufferedImage(GrayFilter.createDisabledImage(img2));
		...
		private static void saveImage(Image img, String filename) {
			BufferedImage bi = ImagingUtility.imageToBufferedImage(img);
