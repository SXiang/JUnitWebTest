...
SELECT @locationID=[Id] FROM [dbo].[Location] WHERE CustomerId=@customerId AND Description='Default'
...
SELECT @locationID=[Id] FROM [dbo].[Location] WHERE CustomerId=@customerId AND Description='CenterPointPerfTestLocation'
...
SELECT @customerId=[Id] FROM [dbo].[Customer] WHERE [Name]=N'Centerpoint' 
SELECT @locationID=[Id] FROM [dbo].[Location] WHERE CustomerId=@customerId AND Description='Texas Region - Houston'
...
SELECT @locationID=[Id] FROM [dbo].[Location] WHERE CustomerId=@customerId AND Description='Geneva'
...
SELECT @locationID=[Id] FROM [dbo].[Location] WHERE CustomerId=@customerId AND Description='Dallas, TX'
...
SELECT @locationID=[Id] FROM [dbo].[Location] WHERE CustomerId=@customerId AND Description='Concord'
...
SELECT @customerId=[Id] FROM [dbo].[Customer] WHERE [Name]=N'PG&E' 
SELECT @locationID=[Id] FROM [dbo].[Location] WHERE CustomerId=@customerId AND Description='Santa Clara'
